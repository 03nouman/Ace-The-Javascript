...
const discordName = new String('nouman1234') // modern methode to crèate string datatype variable
...
// console.log(discordName.substring(0,3));// result: nou,Returns the substring at the specified location within a String object.
// console.log(discordName.slice(0,3)); //results: nou, Returns a section of a string.
...
// console.log(pharse.split('apple',1)); // result:[ 'eat '], Split a string into substrings using the specified separator and return them as an array.
